    ...
    for frame_num in strokes_frames:
        ...
        while True:
            ...
            try:
                ...
                print('error:'+str(starting_frame + i))
            i += 1
...
def find_strokes_indices(player_1_boxes, ball_positions, skeleton_df, verbose=0):
    """
    ...
    return strokes_1_indices, bounces_indices
...
def add_data_to_video(input_video, court_detector, players_detector, ball_detector, strokes_predictions, skeleton_df,
                      statistics,
                      show_video, with_frame, output_folder, output_file, p1):
    """
...
def video_process(video_path, show_video=False, include_video=True,
                  ...
                  output_file=None, output_folder='../output',
    ...
    player_1_strokes_indices, bounces_indices = find_strokes_indices(
    ...
    add_data_to_video(input_video=video_path, court_detector=court_detector, players_detector=detection_model,
                      ...
                      p1=player_1_strokes_indices)


def main():
    s = time.time()
    video_path = '../video/vid6.mp4'
    video_process(video_path=video_path, show_video=True, stickman=True, stickman_box=False, smoothing=True,
                  court=True, top_view=True, output_file='result_'+video_path.split('/')[-1][:-4])
