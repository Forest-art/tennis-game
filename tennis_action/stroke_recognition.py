...
class ActionRecognition:
    ...
    def __init__(self, model_saved_state, max_seq_len=55):
        ...
        self.strokes_label = ['Forehand', 'Backhand', 'Smash']
    ...
    def add_frame(self, frame, player_box):
        ...
        if int(box_center[1] - self.box_margin)>=0 and int(box_center[0] - self.box_margin)>=1:
            ...
            return None
        # patch = frame[int(box_center[1] - box_margin): int(box_center[1] + box_margin),
        #         int(box_center[0] - box_margin): int(box_center[0] + box_margin)].copy()
